...
echo "$makes" | while read -r f;do
    ...
    LD_LIBRARY_PATH=/home/pi/vendor_hardware_overlay/build/signapk/ java -jar signapk/signapk.jar keys/platform.x509.pem keys/platform.pk8 "${name}-unsigned.apk" "${name}.apk"
